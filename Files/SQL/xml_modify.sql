...
replace value of (/ts:Estructuras/ts:Estructura/@Nombre)[1]
with "CDMX"
')

set @xml.modify('
declare namespace ts="http://estructuras.org"; 
delete (/ts:Estructuras/ts:Estructura/@Nombre)[1]
')

set @xml.modify('
declare namespace ts="http://estructuras.org"; 
insert attribute Nombre{"DISTRITO FEDERAL"}
into (/ts:Estructuras/ts:Estructura)[1]
')

set @xml.modify('
declare namespace ts="http://estructuras.org"; 
declare namespace cl="http://clientes.org";
insert text{"Esto es una nota de la dirección del cliente"}
into (/ts:Estructuras/ts:Estructura[1]/cl:Clientes/cl:Cliente[1]/cl:Direcciones/cl:Direccion)[1]
')

declare @textoNodo varchar(100) = 'Este texto se einserta desde una variable de SQL'

set @xml.modify('
declare namespace ts="http://estructuras.org"; 
declare namespace cl="http://clientes.org";
insert text{sql:variable("@textoNodo")}
into (/ts:Estructuras/ts:Estructura[2]/cl:Clientes/cl:Cliente[1]/cl:Direcciones/cl:Direccion)[1]
')
...
declare namespace ts="http://estructuras.org"; 
declare namespace cl="http://clientes.org";
/ts:Estructuras/ts:Estructura[@ID="004"]
')

declare @EstructuraId varchar(5) = '005', @EstructuraNombre varchar(50) = 'Zacatecas Ajua Ajua'

set @nodo5.modify('
declare namespace ts="http://estructuras.org"; 
declare namespace cl="http://clientes.org";

replace value of (/ts:Estructura/@ID)[1]
with sql:variable("@EstructuraId")
')
...
replace value of (ts:Estructura/@Nombre)[1]
with sql:variable("@EstructuraNombre")
')
...
insert sql:variable("@nodo5")
as last into (/ts:Estructuras)[1]
')
