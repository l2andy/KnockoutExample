...
;with xmlnamespaces('http://estructuras.org' as ts, 'http://clientes.org' as cl)
select 
	doc.nod.query('ts:Estructura[@ID="001"]/cl:Clientes/cl:Cliente[@RFC="XXX071221BBB"]/cl:DatosContacto/cl:Telefonos/cl:Telefono[1]') xml_content_xpath
from @xml.nodes('ts:Estructuras') doc(nod)
...
--;with xmlnamespaces('http://estructuras.org' as ts, 'http://clientes.org' as cl)
--select 
--	doc.nod.query('//cl:Telefono[1]') xml_content_xpath_2
